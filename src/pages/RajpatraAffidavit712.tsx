      ...
      <div className="rajpatra-print-page">
        <style>{`
          @media print {
            ...
            .rp712-box { border: 2px solid #000 !important; margin: 10mm auto !important; page-break-after: always; }
            .rp712-box:last-of-type { page-break-after: auto; }
          }
          .rp712-box {
            max-width: 170mm; width: 170mm; margin: 20px auto; padding: 24px 28px;
            font-family: 'Noto Sans Devanagari', serif;
            border: 2px solid #000; background: #fff; color: #000; line-height: 1.65;
            box-sizing: border-box; font-size: 11px; text-align: justify;
          }
          .rp712-box + .rp712-box { margin-top: 30px; }
          .rp712-title { text-align: center; font-size: 20px; font-weight: 800; margin-bottom: 10px; }
          .rp712-sub { font-size: 10px; text-align: center; font-style: italic; margin-bottom: 12px; color: #444; }
          .rp712-to { font-size: 11px; margin-bottom: 8px; }
          .rp712-to p { margin: 1px 0; }
          .rp712-subject { font-size: 12px; font-weight: 800; margin: 10px 0 8px; }
          .rp712-body { font-size: 11px; margin-bottom: 6px; }
          .rp712-list { margin: 6px 0 6px 20px; font-size: 11px; }
          .rp712-list li { margin: 2px 0; }
          .rp712-ol { margin: 6px 0 6px 20px; font-size: 11px; }
          .rp712-ol li { margin: 2px 0; }
          .rp712-footer { display: flex; justify-content: space-between; margin-top: 20px; font-size: 11px; }
          .rp712-footer p { margin: 1px 0; }
          .rp712-bold { font-weight: 700; }
          .rp712-info-row { display: flex; gap: 16px; flex-wrap: wrap; font-size: 11px; margin: 4px 0; }
          .rp712-info-row span { white-space: nowrap; }
          .rp712-section-title { text-align: center; font-size: 14px; font-weight: 800; margin: 12px 0 8px; padding: 4px 0; border-top: 1px solid #333; border-bottom: 1px solid #333; }
        `}</style>
        ...
        <div className="rp712-box">
          ...
          <p className="rp712-body">
            मी खाली सही करणारा/करणारी, नम्रपणे अर्ज करतो/करते की, माझ्या शेतजमिनीच्या 7/12 उताऱ्यावर <b>नावामध्ये चूक झालेली आहे</b>.
            सदर चूक दुरुस्त करून <b>योग्य नाव नोंदविण्यात यावे</b>, ही नम्र विनंती आहे.
          </p>
          ...
          <p className="rp712-body">
            वरील सर्व कागदपत्रांनुसार माझ्या शेतजमिनीच्या 7/12 उताऱ्यावर <b>चुकीचे नाव दुरुस्त करून योग्य नाव नोंदविण्यात यावे</b>, ही नम्र विनंती.
            आपण या अर्जाचा सहानुभूतीपूर्वक विचार करून योग्य ती कार्यवाही करावी, ही विनंती.
          </p>
        ...
        <div className="rp712-box">
          ...
          <p className="rp712-body" style={{ marginTop: 8 }}>
            हा सत्यप्रतिज्ञेवर खालीलप्रमाणे शपथपूर्वक कथन करीत आहे की –
          </p>

          <p className="rp712-body">
            मी माझ्या शेतजमिनीच्या <b>7/12 उताऱ्यावर नाव दुरुस्ती करिता अर्ज</b> मा. विद्यमान कार्यकारी दंडाधिकारी
            साहेब, {printData.taluka} यांच्याकडे सादर केलेला आहे. सदर अर्जामध्ये नमूद केलेली सर्व माहिती, तपशील व
            निवेदन हे माझ्या <b>वैयक्तिक माहितीनुसार पूर्णतः खरे, अचूक व सत्य</b> आहेत.
          </p>
          ...
          <p className="rp712-body">
            सदर नाव दुरुस्ती ही अर्जासोबत सादर केलेल्या <b>अधिकृत कागदपत्रांनुसार</b> करणे आवश्यक असून, यासाठी माझ्या नावाचा
            <b> राजपत्र (Gazette Notification)</b> प्रकाशित झालेला आहे व त्याची प्रत अर्जासोबत जोडलेली आहे.
            अर्जासोबत सादर केलेले सर्व कागदपत्रे (7/12 उतारा, राजपत्र, ओळखपत्रे इ.) ही <b>खरी, वैध व कोणताही फेरफार न केलेली</b> आहेत.
          </p>

          <p className="rp712-body">
            भविष्यात वरील माहितीपैकी कोणतीही माहिती <b>खोटी, चुकीची अथवा दिशाभूल करणारी</b> आढळल्यास,
            त्याबाबत होणाऱ्या सर्व <b>कायदेशीर कारवाईस मी स्वतः जबाबदार राहीन</b>.
            हे शपथपत्र मी कोणत्याही दबावाशिवाय, स्वेच्छेने व <b>पूर्ण शुद्धीत</b> देत आहे.
          </p>

          <div className="rp712-section-title">सत्यापन</div>

          <p className="rp712-body">
            मी, वरील शपथकर्ता, हे सत्यप्रतिज्ञेवर जाहीर करतो/करते की, वरील शपथपत्रातील सर्व मजकूर माझ्या माहितीनुसार
            <b> पूर्णतः खरा व सत्य</b> आहे. वरील माहिती खोटी आढळल्यास, मी <b>भा.दं.वि. कलम 193(2), 199 व 200</b> अन्वये
            शिक्षेस पात्र राहीन, याची मला पूर्ण जाणीव आहे.
            आज दिनांक <b>{printData.date}</b> रोजी समक्ष स्वाक्षरी करीत आहे.
          </p>
