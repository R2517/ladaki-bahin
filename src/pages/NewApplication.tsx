...
const NewApplication = () => {
  ...
  const handleSaveAndPrint = async () => {
    ...
    setSaving(true);
    try {
      toast.success("नवीन अर्ज यशस्वीपणे सेव्ह झाला!");
    } finally {
      setSaving(false);
    }
    setTimeout(() => {
  ...
  return (
    <div className="dash-root">
        ...
        {!showForm ? (
          <div style={{ display: "flex", justifyContent: "center", paddingTop: 20 }}>
            ...
            >
              ...
              <div
                ...
                style={{ background: "linear-gradient(135deg, #EDE9FE, #DDD6FE)", width: 64, height: 64 }}
              >
                <FilePlus size={30} color="#7C3AED" strokeWidth={1.8} />
              </div>
          ...
          <div className="form-container">
            <div className="form-header" style={{ background: themeGradient }}>
              <h1 className="form-heading">नवीन अर्ज (New Application)</h1>
              <p className="form-subheading">नवीन अर्जासाठी माहिती भरा</p>
            </div>
            <div className="form-body">
              ...
              <div className="input-group">
                <label>अर्जाचा प्रकार</label>
                <input type="text" value={applicationType} onChange={(e) => setApplicationType(e.target.value)} placeholder="उदा. लाडकी बहिण योजना, शेतकरी योजना" />
              </div>
      ...
      <div className="print-only a4-page">
        ...
        <div className="print-row"><span className="print-label">अर्जाचा प्रकार :</span><span className="print-value-underline">{applicationType || "________________________"}</span></div>
