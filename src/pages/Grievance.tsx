  ...
  return (
    <div className="dash-root">
          ...
          <div style={{ display: "flex", justifyContent: "center", paddingTop: 20 }}>
            ...
            >
              ...
              <div
                ...
                style={{ background: "linear-gradient(135deg, #FEF3C7, #FDE68A)", width: 64, height: 64 }}
              >
          ...
          <div className="form-container">
            ...
            <div className="form-body">
              ...
              <div className="input-group">
                ...
                <textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="तक्रारीचे सविस्तर वर्णन लिहा..." rows={4} style={{ width: "100%", padding: "10px 14px", fontSize: 13, fontFamily: "'Noto Sans Devanagari', sans-serif", border: "1.5px solid hsl(var(--border))", borderRadius: 10, background: "hsl(var(--card))", resize: "vertical" }} />
              </div>
      ...
      <div className="print-only a4-page">
        ...
        <p style={{ border: "1px solid #333", padding: 12, minHeight: 80, marginTop: 4 }}>{description}</p>
