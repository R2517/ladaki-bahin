...
const Grievance = () => {
  ...
  const validate = () => {
    ...
    if (!description.trim()) {
      toast.error("कृपया तक्रारीचे वर्णन लिहा");
      return false;
    }
    return true;
  };
  const handleSaveAndPrint = async () => {
    ...
    setSaving(true);
    try {
      toast.success("तक्रार नोंदणी यशस्वी!");
    } finally {
      setSaving(false);
    }
    setTimeout(() => {
  ...
  return <div className="dash-root">
      ...
      background: themeGradient
        ...
        <div className="dash-nav-inner">
          <div className="dash-brand" style={{
          cursor: "pointer"
        }} onClick={() => navigate("/")}>
      ...
      <div className="no-print form-page-wrapper">
        ...
        paddingTop: 20
            ...
            <button className="dash-card hamipatra-hero-card" style={{
          maxWidth: 240,
          ...
          animationDelay: "0s"
            ...
            height: 64
                ...
                <AlertTriangle size={30} color="#D97706" strokeWidth={1.8} />
              </div>
              <span className="dash-card-label" style={{
            fontSize: 14
          }}>तक्रार नोंदणी (Grievance)</span>
              <span style={{
            fontSize: 11,
          ...
          background: themeGradient
              ...
              <h1 className="form-heading">तक्रार नोंदणी (Grievance)</h1>
              <p className="form-subheading">तक्रार नोंदणीसाठी माहिती भरा</p>
            </div>
            <div className="form-body">
              ...
              <div className="input-group">
                <label>तक्रारीचा प्रकार</label>
                <input type="text" value={grievanceType} onChange={e => setGrievanceType(e.target.value)} placeholder="उदा. e-KYC, बँक तपशील, अर्ज नामंजूर" />
              </div>
              <div className="input-group">
                <label>तक्रारीचे वर्णन *</label>
                <textarea value={description} onChange={e => setDescription(e.target.value)} placeholder="तक्रारीचे सविस्तर वर्णन लिहा..." rows={4} style={{
              width: "100%",
              padding: "10px 14px",
              fontSize: 13,
      ...
      <div className="print-only a4-page">
        ...
        <div className="print-row">
          ...
          marginLeft: 20
        }}>मोबाईल क्र. :</span><span className="print-value-underline">{mobile}</span>
        </div>
        ...
        <div className="print-row">
          ...
          <span className="print-label" style={{
          marginLeft: 20
        }}>जिल्हा :</span><span className="print-value-underline">{district}</span>
        </div>
        <div className="print-row"><span className="print-label">तक्रारीचा प्रकार :</span><span className="print-value-underline">{grievanceType || "________________________"}</span></div>
        ...
        <div className="print-footer">
          ...
          <div className="print-footer-row" style={{
          marginTop: 10
        }}><span>दिनांक : {getTodayDate()}</span><span>अर्जदाराचे नाव : {name || "_______________"}</span></div>
        </div>
      </div>
    </div>;
};
