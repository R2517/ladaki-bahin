...
const categories = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "किमान किती रिचार्ज करता येते?", a: "किमान ₹10 पासून वॉलेट रिचार्ज करता येते. कोणतीही जास्तीत जास्त मर्यादा नाही." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "प्रत्येक फॉर्मचे शुल्क किती?", a: "वेगवेगळ्या फॉर्म्सचे शुल्क वेगवेगळे आहे. साधारणपणे ₹1 ते ₹5 प्रति फॉर्म. हमीपत्र, स्वयंघोषणा — ₹1 पासून. PAN Card, Voter ID — ₹3 पासून. तपशीलवार किंमत डॅशबोर्ड मध्ये दिसते." },
  ...
  },
  {
    ...
    faqs: [
      { q: "कोणते प्लॅन उपलब्ध आहेत?", a: "बेसिक (मोफत) — सर्व फॉर्म्स वापरा, प्रति फॉर्म शुल्क. प्रो (₹49/महिना) — कमी शुल्क दर, प्राधान्य सपोर्ट, बल्क प्रिंट, अॅडव्हान्स रिपोर्ट्स. एंटरप्राइज — कस्टम ब्रँडिंग, API ऍक्सेस, डेडिकेटेड सपोर्ट." },
